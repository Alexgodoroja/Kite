...
class ProfileViewTest(TestCase):
    ...
    def test_unsuccesful_profile_update(self):
        ...
        self.assertEqual(self.user.email, "johnsmith@example.org")
        self.assertEqual(self.user.bio, "Hello, I'm John Smith.")
    ...
    def test_succesful_profile_update(self):
        ...
        self.user.refresh_from_db()
        self.assertEqual(self.user.username, "@johnsmith2")
        self.assertEqual(self.user.first_name, "John2")
        self.assertEqual(self.user.last_name, "Smith2")
        self.assertEqual(self.user.email, "johnsmith2@example.org")
